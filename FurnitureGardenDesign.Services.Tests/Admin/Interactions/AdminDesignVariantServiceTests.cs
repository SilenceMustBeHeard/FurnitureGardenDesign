...
namespace FurnitureGardenDesign.Services.Tests.Admin.Interactions
{
    [TestFixture]
    public class AdminDesignVariantServiceTests
    {
        ...
        private AdminDesignVariantService _service;
        ...
        public void SetUp()
        {
            ...
            _service = new AdminDesignVariantService(
        ...
        public async Task CreateDesignVariantAsync_CreatesAndReturnsVariant()
        {
            ...
            _designVariantRepositoryMock.Verify(r => r.AddAsync(It
                .IsAny<DesignVariant>()), Times.Once);
        ...
        public void SendDesignVariantProposalAsync_ThrowsKeyNotFoundException_WhenVariantNotFound()
        {
            ...
            _orderRepositoryMock.Verify(r => r.UpdateStatusAsync(It
                .IsAny<Guid>(), It.IsAny<OrderStatus>()), Times.Never);

            _inboxMessageRepositoryMock.Verify(r => r.AddAsync(It
        ...
        public void DeleteDesignVariantAsync_ThrowsKeyNotFoundException_WhenVariantNotFound()
        {
            ...
            var ex = Assert.ThrowsAsync<KeyNotFoundException>(
                ...
                .DeleteDesignVariantAsync(nonExistentId));

            Assert.That(ex.Message, Is.EqualTo($"Design variant with ID {nonExistentId} not found."));

            _designVariantRepositoryMock.Verify(r => r.Delete(It
                .IsAny<DesignVariant>()), Times.Never);
        }
